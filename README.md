...
You can also set sslVerify explicitly. Download the lastest cacert.pem file here: https://curl.se/docs/caextract.html. Set the path to the cacert in the .ini file. You may also be able to set sslVerify to 'true' if you already have cacert.pem configured
